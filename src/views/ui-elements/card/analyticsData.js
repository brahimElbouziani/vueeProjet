...
export default {
    ...
    revenueComparisonLine: {
        series: [{
                name: "This Month",
                data: [8500, 8700, 8480, 8750, 8550, 8800, 8650, 8860]
            },
            {
                name: "Last Month",
                data: [7600, 7800, 7550, 7660, 7450, 7650, 7500, 7700]
            }
        ],
        chartOptions: {
            chart: {
            ...
            fill: {
                ...
                gradient: {
                    shade: 'dark',
                    inverseColors: false,
                    gradientToColors: ['#00B661', '#b8c2cc'],
                    shadeIntensity: 1,
                    type: 'horizontal',
                    opacityFrom: 1,
                    opacityTo: 1,
            ...
            yaxis: {
                ...
                labels: {
                    ...
                    formatter: function(val) {
                        return val  ;//> 999 ? (val / 1000).toFixed(1) + '00' : val;
                    }
                }
            },
            tooltip: {
    ...
    salesBar: {
        ...
        chartOptions: {
            ...
            colors: ['#e6edf7', '#e6edf7', '#00B661', '#e6edf7', '#e6edf7', '#e6edf7'],
            plotOptions: {
                bar: {
                    columnWidth: '45%',
                    distributed: true,
    ...
    sessionsByDeviceDonut: {
        ...
        chartOptions: {
            ...
            stroke: { width: 0 },
            colors: [  '#ff9411', '#c41432'],
            fill: {
                type: 'gradient',
                gradient: {
                    gradientToColors: ['#ffb04f' ,'#fc5a44' ]
                }
            }
        }
    },
    ...
    customersPie: {
        ...
        chartOptions: {
            ...
            colors: ['#d8ff7e', '#FF9F43', '#EA5455'],
            fill: {
                type: 'gradient',
                gradient: {
                    gradientToColors: ['#97e7a2', '#FFC085', '#f29292']
                }
            }
        }
    },
    ...
    browserAnalytics: [{
            ...
            name: 'Seller',
            ratio: 73,
            time: 'Mon Dec 10 2019 07:46:05 GMT+0000 (GMT)',
            comparedResult: '800'
        },
        {
            id: 3,
