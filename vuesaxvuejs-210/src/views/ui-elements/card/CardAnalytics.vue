                    ...
                    <div slot="no-body" class="p-6 pb-0">
                        <div class="flex">
                            <div class="mr-6">
                                ...
                                <p class="text-3xl text-success"><sup class="text-base mr-1">DH</sup>8 600</p>
                            </div>
                            <div>
                                <p class="mb-1 font-semibold">Last Month</p>
                                <p class="text-3xl"><sup class="text-base mr-1">DH</sup>7 300</p>
                            </div>
                        </div>
            ...
            <div class="vx-col w-full md:w-1/3 mb-base">
                <vx-card title="Goal Overview">
                    ...
                    <template slot="no-body">
                        <div class="mt-10">
                            <vue-apex-charts type=radialBar height=260 :options="analyticsData.goalOverviewRadialBar.chartOptions" :series="analyticsData.goalOverviewRadialBar.series" />
                        </div>
                    </template>
