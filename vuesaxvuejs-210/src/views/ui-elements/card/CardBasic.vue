        ...
        <div class="vx-row">
            <div class="vx-col w-full sm:w-1/2 md:w-1/3 mb-base">
                <vx-card>
                    ...
                    <div class="flex justify-between flex-wrap">
                        <vs-button class="mt-4 shadow-lg" type="gradient" color="#00B661" gradient-color-secondary="#CE9FFC">Download</vs-button>
            ...
            <div class="vx-col w-full sm:w-1/2 md:w-1/3 mb-base">
                <vx-card>
                    ...
                    <div class="flex justify-between flex-wrap">
                        <vs-button class="mt-4 shadow-lg" type="gradient" color="#00B661" gradient-color-secondary="#CE9FFC">{{ card_3.btn_left_text }}</vs-button>
            ...
            <div class="vx-col w-full sm:w-1/2 md:w-1/3 mb-base">
                <vx-card class="p-2">
                    ...
                    <div class="flex justify-between flex-wrap">
                        <vs-button class="mt-4 shadow-lg" type="gradient" color="#00B661" gradient-color-secondary="#CE9FFC">{{ card_4.btn_1_text }}</vs-button>
            ...
            <div class="vx-col w-full md:w-1/3 sm:w-1/2 mb-base">
                <vx-card class="p-2">
                    ...
                    <vs-button type="gradient" class="w-full mt-6" color="#00B661" gradient-color-secondary="#CE9FFC">{{ card_5.btn_text }}</vs-button>
                </vx-card>
            </div>
            ...
            <div class="vx-col w-full md:w-1/3 sm:w-1/2 mb-base">
                <vx-card class="p-2">
                    ...
                    <div class="flex justify-between flex-wrap">
                        <vs-button class="mt-4 shadow-lg" type="gradient" color="#00B661" gradient-color-secondary="#CE9FFC">{{ card_6.btn_left_text }}</vs-button>
